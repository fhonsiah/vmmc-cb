package org.smartregister.chw.vmmc.repository;
...
public class VisitRepository extends BaseRepository {
    ...
    public void setNotVisitingDate(String date, String baseID) {
        try {
            ...
            getWritableDatabase().update(Constants.TABLES.VMMC_ENROLLMENT, values, DBConstants.KEY.BASE_ENTITY_ID + " = ?", new String[]{baseID});
        } catch (Exception e) {
            Timber.e(e);
        }
    }
    ...
    public String getLastInteractedWithAndVisitNotDone(String baseEntityID, String dateColumn) {
        ...
        try {
            ...
            cursor = database.query(Constants.TABLES.VMMC_ENROLLMENT, new String[]{dateColumn}, BASE_ENTITY_ID + " = ? " + COLLATE_NOCASE, new String[]{baseEntityID}, null, null, null);
