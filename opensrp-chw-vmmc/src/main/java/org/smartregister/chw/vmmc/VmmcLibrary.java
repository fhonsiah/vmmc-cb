package org.smartregister.chw.vmmc;
...
public class VmmcLibrary {
    private static VmmcLibrary instance;
    ...
    public void setSubmitOnSave(boolean submitOnSave) {
        VmmcLibrary.submitOnSave = submitOnSave;
    }
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new VmmcLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static VmmcLibrary getInstance() {
        if (instance == null) {
    ...
    private VmmcLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
