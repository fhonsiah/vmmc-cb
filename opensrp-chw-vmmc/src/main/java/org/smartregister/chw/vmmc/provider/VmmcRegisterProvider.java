package org.smartregister.chw.vmmc.provider;
...
public class VmmcRegisterProvider implements RecyclerViewProvider<VmmcRegisterProvider.RegisterViewHolder> {
    ...
    public VmmcRegisterProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
    ...
    private String updateMemberGender(CommonPersonObjectClient commonPersonObjectClient) {
        if ("0".equals(Utils.getValue(commonPersonObjectClient.getColumnmaps(), DBConstants.KEY.IS_ANC_CLOSED, false))) {
            ...
            return VmmcUtil.getGenderTranslated(context, gender);
        }
    }
    ...
    private void populatePatientColumn(CommonPersonObjectClient pc, final RegisterViewHolder viewHolder) {
        try {
            ...
            viewHolder.patientColumn.setTag(R.id.VIEW_ID, BaseVmmcRegisterFragment.CLICK_VIEW_NORMAL);

            viewHolder.dueButton.setOnClickListener(onClickListener);
            viewHolder.dueButton.setTag(pc);
            viewHolder.dueButton.setTag(R.id.VIEW_ID, BaseVmmcRegisterFragment.FOLLOW_UP_VISIT);
...
//        implement
    ...
    public RegisterViewHolder createViewHolder(ViewGroup parent) {
        View view = inflater.inflate(R.layout.vmmc_register_list_row, parent, false);
