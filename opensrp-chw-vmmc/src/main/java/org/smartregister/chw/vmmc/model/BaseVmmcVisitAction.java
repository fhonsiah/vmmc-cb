...
public class BaseVmmcVisitAction {
    ...
    public interface VmmcVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseVmmcVisitAction vmmcVisitAction);
    }
    ...
    public static class Builder {
        ...
        public BaseVmmcVisitAction build() throws ValidationException {
            return new BaseVmmcVisitAction(this);
        }
    }
