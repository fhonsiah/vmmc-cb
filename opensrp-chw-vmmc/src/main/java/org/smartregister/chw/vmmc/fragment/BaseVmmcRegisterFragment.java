...
public class BaseVmmcRegisterFragment extends BaseRegisterFragment implements VmmcRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        VmmcRegisterProvider vmmcRegisterProvider = new VmmcRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.vmmc));
            titleView.setFontVariant(FontVariant.REGULAR);
        }
    }

    @Override
    public VmmcRegisterFragmentContract.Presenter presenter() {
        return (VmmcRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseVmmcRegisterFragmentPresenter(this, new BaseVmmcRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseVmmcProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
