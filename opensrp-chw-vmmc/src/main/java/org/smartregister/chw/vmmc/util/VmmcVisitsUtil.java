...
public class VmmcVisitsUtil extends VisitUtils {
    ...
    public static void processVisits() throws Exception {
        processVisits(VmmcLibrary.getInstance().visitRepository(), VmmcLibrary.getInstance().visitDetailsRepository());
    }
...
//        baseEvent.setEventType(Constants.EVENT_TYPE.PrEP_CLIENT_NOT_ELIGIBLE);
    ...
    public static void manualProcessVisit(Visit visit) throws Exception {
        ...
        VisitDetailsRepository visitDetailsRepository = VmmcLibrary.getInstance().visitDetailsRepository();
        VisitRepository visitRepository = VmmcLibrary.getInstance().visitRepository();
