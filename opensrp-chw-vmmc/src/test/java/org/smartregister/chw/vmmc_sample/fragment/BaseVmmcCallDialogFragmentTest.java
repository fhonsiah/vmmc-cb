...
public class BaseVmmcCallDialogFragmentTest {
    @Spy
    public BaseVmmcCallDialogFragment baseTestCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseVmmcCallDialogFragment.class, "MEMBER_OBJECT", vmmcMemberObject);
    }
    ...
    public void setCallTitleFamilyHead() throws Exception {
        ...
        Mockito.when(vmmcMemberObject.getBaseEntityId()).thenReturn("123456");
        Mockito.when(vmmcMemberObject.getFamilyHead()).thenReturn("123456");
    ...
    public void setCallTitleCareGiver() throws Exception {
        ...
        Mockito.when(vmmcMemberObject.getBaseEntityId()).thenReturn("123456");
        Mockito.when(vmmcMemberObject.getPrimaryCareGiver()).thenReturn("123456");
    ...
    public void setCallTitle() throws Exception {
        ...
        Mockito.when(vmmcMemberObject.getBaseEntityId()).thenReturn("1");
        Mockito.when(vmmcMemberObject.getFamilyHead()).thenReturn("123456");
    ...
    public void initUI() throws Exception {
        Mockito.when(vmmcMemberObject.getPhoneNumber()).thenReturn("123456789");
