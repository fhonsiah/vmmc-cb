package org.smartregister.chw.vmmc_sample.repository;
...
import org.smartregister.chw.vmmc_sample.BuildConfig;
import org.smartregister.chw.vmmc_sample.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        VmmcLibrary.getInstance().visitRepository().createTable(database);
        VmmcLibrary.getInstance().visitDetailsRepository().createTable(database);
